...
async function deploy() {
    ...
    const mod = require("./build/VilitigoCounter_VilitigoCounterFinal.ts");

    // Use fromInit with owner = deployer wallet address
    const contract = await mod.VilitigoCounterFinal.fromInit(wallet.address);
    ...
    console.log("1. Update CONTRACT_ADDRESS in index.html to:", contract.address.toString());
    console.log("2. Update vitiligo.ton DNS to point to this address");
}
